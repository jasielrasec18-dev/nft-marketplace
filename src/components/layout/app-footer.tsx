  ...
  return <footer className="mt-12 pb-24 lg:pb-6">
    <PageContainer>
      ...
      <div className="grid gap-6 bg-card p-6 sm:grid-cols-3">
        ...
        <div className="space-y-3"><h2 className="type-card">Meu perfil</h2><p className="type-caption text-muted-foreground">Conta, carteira e coleção estarão disponíveis nas próximas etapas.</p></div>
