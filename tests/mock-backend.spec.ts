...
test('retired template artwork migrates without resetting accounts, prices or order snapshots', async () => {
  ...
  expect(restored.nfts[0]?.imageUrl).toBe('/artwork/golden-768.webp')
  expect(restored.nfts[0]?.gallery).toEqual(['/artwork/golden-768.webp', '/artwork/golden-768.webp', '/custom-art.svg'])
